        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex flex-col">
            <div className="flex items-baseline gap-1.5">
              <span className={cn("font-medium text-xl", isToday ? "text-[#4F2D9E]" : "text-gray-800")}>
                {format(date, dayFormat)}
              </span>
              <span className={cn("text-sm", isToday ? "text-[#4F2D9E]/80" : "text-gray-600")}>
                {format(date, monthFormat)}
              </span>
            </div>
            <span className={cn("text-xs font-medium mt-0.5", isToday ? "text-[#4F2D9E]/80" : "text-gray-500")}>
